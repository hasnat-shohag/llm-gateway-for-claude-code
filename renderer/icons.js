...
const PATHS = {
  ...
  coins: [
    ['ellipse', { cx: 8, cy: 4.3, rx: 4.8, ry: 2 }],
    ['path', { d: 'M3.2 4.3v3.4c0 1.1 2.1 2 4.8 2s4.8-.9 4.8-2V4.3' }],
    ['path', { d: 'M3.2 7.7v3.4c0 1.1 2.1 2 4.8 2s4.8-.9 4.8-2V7.7' }],
  ],
  layers: [
    ['path', { d: 'M8 2.2l5.3 2.6L8 7.4 2.7 4.8z' }],
    ['path', { d: 'M2.7 8.2L8 10.8l5.3-2.6' }],
    ['path', { d: 'M2.7 11.4L8 14l5.3-2.6' }],
  ],
